...
# To Do: Write validation to ensure required elements are present and the correct format before writing.
# This should also be done on the front end, but MongoDB doesn't provide native help with validation
my_documents = [
    {
...
def main():
    ...
    project_doc = {
        ...
        'author_id': 0, # automatically generated by MongoDB ?
        'cohort_id': 0, # automatically generated by MongoDB ?
        'author_name': "Cynthia O'Donnell",
        'link': "https://www.github.com",
        'created_date': datetime() # how do we create now() in MongoDB ?
    }
...
dbh.projects.insert(project_doc, safe=True)
# safe=True ensures that your write will succeed or an exception will be thrown
print "Successfully inserted document: %s" % project_doc
